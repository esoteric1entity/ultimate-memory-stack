...
On 2026-08-22 a single review pass found **two wrong citations in shipped documentation** and, in
...
| **Venue** | No `journal_ref` or DOI in arXiv metadata (checked 2026-08-22) |
...
| **Verified** | 2026-08-22 — title, authors, and date read from the arXiv API |
...
2. We wrote **"Chalef et al."** for over a year. Daniel Chalef is the **last of five** authors; the
   first author is **Rasmussen**. Corrected 2026-08-22.
...
⚠️ Both citing tables called this a **"peer-reviewed paper"** until 2026-08-22. It is an arXiv
...
| **Verified** | 2026-08-22 — title and 2025-06 date confirmed; Huiqiang Jiang is a shared author with the LLMLingua line, which is the basis for calling it a successor |
