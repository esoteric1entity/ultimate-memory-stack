...
The general edition is **field-agnostic** and ships **no PHI/HIPAA handling** — a `healthcare` preset is **not selectable** here (the wizard refuses it). HIPAA/PHI is out of scope for this edition. Optional, user-selected protection:
